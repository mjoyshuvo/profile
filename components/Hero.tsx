      ...
      <div className="mx-auto grid w-full max-w-6xl gap-6 px-5 sm:gap-10 sm:px-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center lg:gap-16">
        ...
        <div className="order-first lg:order-2 lg:w-80">
          ...
          <Reveal delay={0.24}>
            ...
            <ul className="mt-4 flex items-center justify-center gap-4 border-t border-rule pt-4 text-xs uppercase tracking-[0.16em] text-ink-soft sm:mt-5 sm:gap-6 lg:mt-7 lg:pt-5">
              {disciplines.map((d, i) => (
