export type Project = {
  ...
  work: string;
  /**
   * The drawing on the resting card — what the product is, as a picture:
   * curves for a data platform, routes and seats for a booking platform, one
   * sign-on hub for a suite, a search box over several products.
   */
  visual: "timeseries" | "routes" | "hub" | "search";
  /**
